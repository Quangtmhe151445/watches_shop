...
<html>
    ...
    <body class="sub_page">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="p-4">
                                    <ul class="list-unstyled mb-4">
                                        <li class="d-flex justify-content-between py-3 border-bottom"><strong class="text-muted">Tổng tiền hàng</strong><strong>${totalPrice}<span>$</span></strong></li>
        ...
        <c:if test="${empty listCart}">
            <table class="table">
            <tr>
                <td><a href="home">Quay lại mua sắm ở đây</a></td>
            <td>
